...
public class AdminController {
	...
	public ResponseEntity<AdminDto> updateAdmin(@PathVariable int adminId,
			@RequestParam("profilePicture") MultipartFile image, @ModelAttribute AdminDto admin) throws Exception {
		...
		AdminDto updatedAdmin = adminServices.updateAdmin(admin, adminId, image);
